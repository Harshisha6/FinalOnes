    ...
    <div className="mx-auto p-4">
      <div className="bg-gray-900 text-white p-8 rounded-t-lg">
        ...
        <div className="flex items-center space-x-4 mt-2 text-sm">
          ...
          <span>
            Created On {typeof studentViewCourseDetails?.date === "string"
      ...
      {assignmentVisible ? (
                  ...
                  {replaceNotes[index] && (
                    <div className="mt-6">
                      ...
                      <Input
                        ...
                        className="mb-4"
                      />
                      <Button className="flex justify-end mt-2" onClick={handleSaveSubmissions}>Finished</Button>
                    </div>
                  )}
                </CardContent>
              </Card>
        ...
        <main className="flex-grow">
          ...
          <Card>
          <CardHeader>
              <CardTitle>Assignment Document</CardTitle>
            </CardHeader>
          <CardContent>
              <iframe
